    ...
    <div style={{ backgroundColor: "#eee", paddingTop: "10px" }}>
      <div className="container">
        <div className="row">
          ...
          <p>
            Our websites may include features such as plugins, buttons, tools,
            or content that link to other companies. We may collect information
            about your use of these features. In addition, when you see or
            interact with these buttons, tools, or content, or view any of our
            web pages containing them, some information from your browser may
          ...
          <p>
            ...
            Facebook, Instagram, Twitter, Google+, Pinterest, and LinkedIn. We
            may collect information when you interact with our social media
            accounts and pages.
          </p>
          <h2>III. HOW WE USE AND SHARE INFORMATION</h2>
          <p>
            The data that we collect about you may be used in the following
            ways:
          </p>
          <ul>
          ...
          <p>
            ...
            patterns of the website. This Privacy Policy does not limit in any
          ...
          <p>
            ...
            breach of such precautions. By using our website, you acknowledge
          ...
          <ul>
            <li>
              ...
              the box that you can click to indicate that you want the
              information to be used for direct marketing purposes and leave it
              unchecked
            </li>
            <li>
          ...
          <p>
            As part of the website, we may provide links to or compatibility
            ...
            solely to information collected by us through the website.
            Therefore, this Privacy Policy does not apply to your use of a
            third-party website accessed by selecting a link via our website. To
            the extent that you access or use the website through or on another
          ...
          <p>
            ...
            website five (5) days after we first post the changes on the website
          ...
          <p>
            ...
            changes here so that you may opt out of the new information
