      ...
      <div className="video-area cta">
        <div className="container">
          <div className="row">
            ...
            >
              <div className="section-title ctas1" style={{ zIndex: "9999" }}>
                {/* <p>
              ...
              <div className="video-btn-section">
                <h2 className="text-success">Watch Video</h2>
                ...
                <a
                  href="https://www.youtube.com/watch?v=0WWzgGyAH6Y"
                  className="video-btn mfp-iframe"
                >
