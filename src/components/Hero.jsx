        ...
        <div className="home2-hero-area">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 text-center col-md-12 wow fadeInLeft d-flex pt-5 justify-content-center"
                        style={
                            {
                                visibility: "visible",
                                animationName: "fadeInLeft"
                        ...
                        <div className="home2-hero-text">
                            ...
                            <a className="home2-download-btn" href="#">
                                ...
                                <img src={hero_app_logo_1}
                                    className="img-fluid"
                                    alt=''/>
                            </a>
                            <a className="home2-download-btn2" href="#">
                                <img src={hero_app_logo_2}
                                    className="img-fluid"
                                    alt=''/>
                            </a>
                        </div>
                        ...
                        <div className="d-flex gap-2 px-5 py-2"
                            ...
                            <div>
                                ...
                                <div className="d-flex justify-content-around"
                                    ...
                                    <img src={Logo_Signature}
                                        className="img-fluid"
                                        alt=''/>
                                    <img src={Aspire_to_Innovate_Seal}
                                        className="img-fluid"
                                        alt=''/>
                                </div>
                            </div>
